    ...
    <footer className="bg-gray-900 text-gray-300 py-16">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-2xl font-bold text-white">BurgerHouse</span>
            </div>
            <p className="text-gray-400 leading-relaxed">
              Serving the finest gourmet burgers since 2010. Quality ingredients, exceptional taste, unforgettable experience.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-white text-xl font-bold mb-4">Opening Hours</h3>
            <ul className="space-y-2">
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          <p className="text-gray-400">© 2024 BurgerHouse. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
